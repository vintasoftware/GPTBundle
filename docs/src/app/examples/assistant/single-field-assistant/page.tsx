...
export default function SingleFieldFormAssistant() {
  ...
  return (
    <>
        ...
        <Text mb="xs">Code at <Code>docs/src/app/examples/assistant/single-field-assistant/page.tsx</Code></Text>
        <Text mb="md">
          This form uses the <Code>useFormAssistant</Code> hook to enable the GPT-4 autofill
          functionality. Click on the button below to test it!
        </Text>
