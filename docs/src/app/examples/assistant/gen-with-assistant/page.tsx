  ...
  return (
    <>
        <Box pos="relative" mb="md">
          ...
          <Text mb="xs">Code at <Code>docs/src/app/examples/assistant/gen-with-assistant/page.tsx</Code></Text>
          <Text mb="xs">
            This form combines <Code>useGeneratedFormSchema</Code> with{' '}
            <Code>useFormAssistant</Code> hooks to generate a form from content + prompt, and then
            support GPT-4 autofill on it.
          </Text>
          <Textarea
