...
<Grid>
  <Grid.Col span={6}>
    <Button fullWidth variant="outline" component={Link} href="/tutorial/getting-started/">
      « Getting Started
    </Button>
  </Grid.Col>
  <Grid.Col span={6}>
    <Button fullWidth variant="outline" component={Link} href="/tutorial/form-assistant/">
      Form Assistant »
    </Button>
  </Grid.Col>
</Grid>
