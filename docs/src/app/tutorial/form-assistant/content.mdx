...
<Stack direction="row" justifyContent="space-between" alignItems="center" spacing={2}>
  <Button variant="outlined" startIcon={<KeyboardDoubleArrowLeftOutlinedIcon />} href="/tutorial/form-generation/">
    <span>Form Generation</span>
  </Button>
  <Button variant="outlined" endIcon={<KeyboardDoubleArrowRightOutlinedIcon />} href="/examples/">
